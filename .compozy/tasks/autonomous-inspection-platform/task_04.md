...
- [x] 4.1 Deliver schedule creation/update/cancel operations, RRULE validation, timezone behavior, and next-occurrence calculation.
- [x] 4.2 Deliver scheduler claiming, JIT materialization, reminder planning, idempotency, and outbox publication.
- [x] 4.3 Deliver manual and milestone occurrence creation using the shared immutable snapshot contract.
- [x] 4.4 Deliver inspection state machine, cancellation, invalidation, responsibility state, and session-revocation events.
- [x] 4.5 Deliver project creation and planned stage snapshots including origin-stage and report-mode configuration.
- [x] 4.6 Deliver exceptional stage, start, skip, close, reopen, ordering, reason, and audit behavior.
- [x] 4.7 Deliver GraphQL operations and event contracts for schedules, inspections, projects, and stage timelines.
- [x] 4.8 Deliver scheduler replica, DST, concurrency, scale, lifecycle, and scope integration coverage.
