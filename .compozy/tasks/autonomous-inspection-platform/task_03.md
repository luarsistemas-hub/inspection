...
- [x] 3.1 Deliver participant, contact, verification, channel-selection, and lifecycle vertical slices.
- [x] 3.2 Deliver segment-definition publication, version validation, safe expression compilation, and catalog queries.
- [x] 3.3 Deliver immutable template-version publication, activation, retirement, and analysis-profile publication.
- [x] 3.4 Deliver policy validation and deterministic template-default/asset-override resolution contracts.
- [x] 3.5 Deliver generic asset registration, segment attributes, location/geofence, relationships, updates, archive, and scoped queries.
- [x] 3.6 Deliver curated property, construction, and cleaning seeds with independent multi-stage and report-mode flags.
- [x] 3.7 Deliver GraphQL schema fragments, resolver registration, connections, mutations, and generated contract fixtures.
- [x] 3.8 Deliver schema, concurrency, idempotency, permission, scale, and tenant-isolation tests for the catalog.
