...
def main():
    parser = argparse.ArgumentParser(
        description="Generate design tokens from a brand color."
    )
    parser.add_argument(
        "brand_color",
        nargs="?",
        default="#0066CC",
        help="Base brand color in hex notation (default: #0066CC)",
    )
    parser.add_argument(
        "style",
        nargs="?",
        choices=("modern", "classic", "playful"),
        default="modern",
    ...
    if args.format == 'summary':
        ...
        print(generator.export_tokens(tokens, args.format))
