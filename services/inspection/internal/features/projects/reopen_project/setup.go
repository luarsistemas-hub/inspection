...
type Command core.TransitionInput
...
func Setup(d Dependencies) error {
	if d.DB == nil || d.Bus == nil {
		return fmt.Errorf("slice projects/reopen_project: missing dependency")
	}
	...
	return d.Bus.RegisterCommand(Command{}, func(ctx context.Context, raw any) (any, error) {
		return s.Reopen(ctx, core.TransitionInput(raw.(Command)))
	})
}
