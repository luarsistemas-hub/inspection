...
const viewerLinks: Array<[string, string]> = [["Início", "/tenants/current"], ["Agendas", "/schedules"], ["Inspeções", "/inspections"], ["Projetos", "/projects"], ["Triagem", "/triage"], ["Relatórios", "/reports"], ["Notificações", "/notifications"]];
