...
export type OriginPromotionQueryVariables = Exact<{
  inspectionId: string | number;
}>;


export type OriginPromotionQuery = { originPromotion: { inspectionId: string, status: string, failureReason: string | null, originVersionId: string | null, eligibleMedia: Array<{ id: string, description: string, url: string | null }> } | null };
...
export type ReportWorkspaceQuery = { report: { id: string, inspectionId: string, projectId: string | null, version: number, mode: string, classification: string, jsonDigest: string, htmlDigest: string, canonicalJSON: Record<string, unknown>, html: string, createdAt: string, advisory: string, pdfStatus: string, context: { asset: { id: string, name: string, externalKey: string, address: string }, participant: { id: string, name: string }, template: { id: string, name: string, version: number }, inspection: { projectId: string | null, stageId: string | null, stageLabel: string | null, dueAt: string | null, submittedAt: string | null, generatedAt: string } }, requirements: Array<{ key: string, section: string, label: string, instructions: string | null, coverage: string | null, impossibilityReason: string | null, coverageStatus: string | null, comparisonStatus: string | null }>, evidence: Array<{ id: string, requirementKey: string, role: string, description: string | null, captureSource: string | null, capturedAt: string | null, displayDigest: string | null, availability: string, flags: Array<string>, url: string | null }>, findings: Array<{ id: string | null, category: string, changeType: string | null, title: string, description: string, severity: string, confidence: number, quality: string, recommendedAction: string, evidenceIds: Array<string> }>, timeline: Array<{ stageId: string, classification: string | null, status: string, position: number }> } | null };
...
export type CustomerReportQuery = { customerReport: { inspectionId: string, snapshotId: string, version: number, classification: string, advisory: string, status: string, historical: boolean, context: { asset: { id: string, name: string, externalKey: string, address: string }, participant: { id: string, name: string }, template: { id: string, name: string, version: number }, inspection: { projectId: string | null, stageId: string | null, stageLabel: string | null, dueAt: string | null, submittedAt: string | null, generatedAt: string } }, requirements: Array<{ key: string, section: string, label: string, instructions: string | null, coverage: string | null, impossibilityReason: string | null, coverageStatus: string | null, comparisonStatus: string | null }> } | null };
...
export type CustomerEvidenceQuery = { customerEvidence: { nodes: Array<{ id: string, requirementKey: string, section: string | null, label: string | null, role: string, description: string | null, captureSource: string | null, capturedAt: string | null, state: string, lineageId: string, replacedBy: string | null, mediaAvailability: string, flags: Array<string>, url: string | null }>, pageInfo: { endCursor: string | null, hasNextPage: boolean } } };
...
export type PromoteInspectionPhotosMutationVariables = Exact<{
  input: PromoteInspectionPhotosInput;
}>;


export type PromoteInspectionPhotosMutation = { promoteInspectionPhotos: { clientMutationId: string, promotion: { inspectionId: string, status: string, failureReason: string | null, originVersionId: string | null, eligibleMedia: Array<{ id: string, description: string, url: string | null }> } | null, userErrors: Array<{ code: string, field: string | null, message: string, correlationId: string }> } };
...
export const OriginPromotionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OriginPromotion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"inspectionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"originPromotion"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"inspectionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"inspectionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"inspectionId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"failureReason"}},{"kind":"Field","name":{"kind":"Name","value":"originVersionId"}},{"kind":"Field","name":{"kind":"Name","value":"eligibleMedia"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}}]}}]} as unknown as DocumentNode<OriginPromotionQuery, OriginPromotionQueryVariables>;
...
export const PromoteInspectionPhotosDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"PromoteInspectionPhotos"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PromoteInspectionPhotosInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"promoteInspectionPhotos"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"promotion"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"inspectionId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"failureReason"}},{"kind":"Field","name":{"kind":"Name","value":"originVersionId"}},{"kind":"Field","name":{"kind":"Name","value":"eligibleMedia"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"userErrors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"field"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}}]}},{"kind":"Field","name":{"kind":"Name","value":"clientMutationId"}}]}}]}}]} as unknown as DocumentNode<PromoteInspectionPhotosMutation, PromoteInspectionPhotosMutationVariables>;
