...
export type AdminAnalysisPromptQueryVariables = Exact<{ [key: string]: never; }>;


export type AdminAnalysisPromptQuery = { analysisPrompt: { analysisType: Schema.AnalysisType, systemPrompt: string, modelAlias: string, minimumConfidenceBps: number, canonicalDigest: string, revision: number, updatedAt: string } };
...
export type AdminGovernanceQuery = { publicationPolicy: { mode: string, version: number }, retentionPolicies: { nodes: Array<{ id: string, evidenceDays: number, operationalDays: number, securityDays: number, version: number }>, pageInfo: { endCursor: string | null, hasNextPage: boolean } }, notificationDeliveries: { nodes: Array<{ id: string, status: string, createdAt: string, updatedAt: string, inspectionId: string | null, invitationId: string | null, logicalTemplate: string, failureCode: string | null, recipientMasked: string | null, responsibilityVersion: number | null, canCorrectResponsibleEmail: boolean }>, pageInfo: { endCursor: string | null, hasNextPage: boolean } } };
...
export type AdminInspectionLlmUsageQueryVariables = Exact<{
  inspectionId: string | number;
  mode?: Schema.LlmExecutionMode | null | undefined;
  first?: number | null | undefined;
  after: string | null | undefined;
}>;


export type AdminInspectionLlmUsageQuery = { inspectionLLMUsage: { inspectionId: string, mode: Schema.LlmExecutionMode, attemptedCalls: number, deliveredCalls: number, incompleteCalls: number, inputTokens: number, outputTokens: number, knownReportedCost: number, unknownCostCalls: number, costComplete: boolean, coverageStartedAt: string | null, coverageComplete: boolean, calls: Array<{ callId: string, jobId: string, eventId: string, executionId: string, correlationId: string, attempt: number, replayGeneration: number, mode: Schema.LlmExecutionMode, comparisonMode: string, modelAlias: string, provider: string | null, model: string | null, gatewayRequestId: string | null, state: Schema.LlmCallState, technicalOutcome: string, transportDelivered: boolean | null, httpStatus: number | null, inputTokens: number | null, outputTokens: number | null, reportedCost: number | null, durationMs: number | null, startedAt: string, finishedAt: string | null }>, pageInfo: { endCursor: string | null, hasNextPage: boolean } } };
...
export type AdminCorrectInspectionResponsibleEmailMutationVariables = Exact<{
  input: Schema.CorrectInspectionResponsibleEmailInput;
}>;


export type AdminCorrectInspectionResponsibleEmailMutation = { correctInspectionResponsibleEmail: { clientMutationId: string, correction: { inspectionId: string, responsibilityId: string, invitationId: string, deliveryId: string | null, deliveryStatus: string, responsibilityStatus: string, responsibilityVersion: number, recipientMasked: string, canCorrectResponsibleEmail: boolean } | null, userErrors: Array<{ code: string, field: string | null, message: string, correlationId: string }> } };

export type AdminUpdateAnalysisPromptMutationVariables = Exact<{
  input: Schema.UpdateAnalysisPromptInput;
}>;


export type AdminUpdateAnalysisPromptMutation = { updateAnalysisPrompt: { clientMutationId: string, prompt: { analysisType: Schema.AnalysisType, systemPrompt: string, modelAlias: string, minimumConfidenceBps: number, canonicalDigest: string, revision: number, updatedAt: string } | null, userErrors: Array<{ code: string, field: string | null, message: string, correlationId: string }> } };
...
export const AdminAnalysisPromptDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdminAnalysisPrompt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"analysisPrompt"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"REAL_ESTATE"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"analysisType"}},{"kind":"Field","name":{"kind":"Name","value":"systemPrompt"}},{"kind":"Field","name":{"kind":"Name","value":"modelAlias"}},{"kind":"Field","name":{"kind":"Name","value":"minimumConfidenceBps"}},{"kind":"Field","name":{"kind":"Name","value":"canonicalDigest"}},{"kind":"Field","name":{"kind":"Name","value":"revision"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<Types.AdminAnalysisPromptQuery, Types.AdminAnalysisPromptQueryVariables>;
...
export const AdminInspectionLlmUsageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdminInspectionLLMUsage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"inspectionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"mode"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"LLMExecutionMode"}},"defaultValue":{"kind":"EnumValue","value":"LIVE"}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}},"defaultValue":{"kind":"IntValue","value":"25"}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"inspectionLLMUsage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"inspectionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"inspectionId"}}},{"kind":"Argument","name":{"kind":"Name","value":"mode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"mode"}}},{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"inspectionId"}},{"kind":"Field","name":{"kind":"Name","value":"mode"}},{"kind":"Field","name":{"kind":"Name","value":"attemptedCalls"}},{"kind":"Field","name":{"kind":"Name","value":"deliveredCalls"}},{"kind":"Field","name":{"kind":"Name","value":"incompleteCalls"}},{"kind":"Field","name":{"kind":"Name","value":"inputTokens"}},{"kind":"Field","name":{"kind":"Name","value":"outputTokens"}},{"kind":"Field","name":{"kind":"Name","value":"knownReportedCost"}},{"kind":"Field","name":{"kind":"Name","value":"unknownCostCalls"}},{"kind":"Field","name":{"kind":"Name","value":"costComplete"}},{"kind":"Field","name":{"kind":"Name","value":"coverageStartedAt"}},{"kind":"Field","name":{"kind":"Name","value":"coverageComplete"}},{"kind":"Field","name":{"kind":"Name","value":"calls"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"callId"}},{"kind":"Field","name":{"kind":"Name","value":"jobId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"executionId"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}},{"kind":"Field","name":{"kind":"Name","value":"attempt"}},{"kind":"Field","name":{"kind":"Name","value":"replayGeneration"}},{"kind":"Field","name":{"kind":"Name","value":"mode"}},{"kind":"Field","name":{"kind":"Name","value":"comparisonMode"}},{"kind":"Field","name":{"kind":"Name","value":"modelAlias"}},{"kind":"Field","name":{"kind":"Name","value":"provider"}},{"kind":"Field","name":{"kind":"Name","value":"model"}},{"kind":"Field","name":{"kind":"Name","value":"gatewayRequestId"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"technicalOutcome"}},{"kind":"Field","name":{"kind":"Name","value":"transportDelivered"}},{"kind":"Field","name":{"kind":"Name","value":"httpStatus"}},{"kind":"Field","name":{"kind":"Name","value":"inputTokens"}},{"kind":"Field","name":{"kind":"Name","value":"outputTokens"}},{"kind":"Field","name":{"kind":"Name","value":"reportedCost"}},{"kind":"Field","name":{"kind":"Name","value":"durationMs"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"finishedAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"endCursor"}},{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}}]}}]}}]}}]} as unknown as DocumentNode<Types.AdminInspectionLlmUsageQuery, Types.AdminInspectionLlmUsageQueryVariables>;
...
export const AdminCorrectInspectionResponsibleEmailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AdminCorrectInspectionResponsibleEmail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CorrectInspectionResponsibleEmailInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"correctInspectionResponsibleEmail"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"correction"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"inspectionId"}},{"kind":"Field","name":{"kind":"Name","value":"responsibilityId"}},{"kind":"Field","name":{"kind":"Name","value":"invitationId"}},{"kind":"Field","name":{"kind":"Name","value":"deliveryId"}},{"kind":"Field","name":{"kind":"Name","value":"deliveryStatus"}},{"kind":"Field","name":{"kind":"Name","value":"responsibilityStatus"}},{"kind":"Field","name":{"kind":"Name","value":"responsibilityVersion"}},{"kind":"Field","name":{"kind":"Name","value":"recipientMasked"}},{"kind":"Field","name":{"kind":"Name","value":"canCorrectResponsibleEmail"}}]}},{"kind":"Field","name":{"kind":"Name","value":"userErrors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"field"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}}]}},{"kind":"Field","name":{"kind":"Name","value":"clientMutationId"}}]}}]}}]} as unknown as DocumentNode<Types.AdminCorrectInspectionResponsibleEmailMutation, Types.AdminCorrectInspectionResponsibleEmailMutationVariables>;
export const AdminUpdateAnalysisPromptDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AdminUpdateAnalysisPrompt"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateAnalysisPromptInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateAnalysisPrompt"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"prompt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"analysisType"}},{"kind":"Field","name":{"kind":"Name","value":"systemPrompt"}},{"kind":"Field","name":{"kind":"Name","value":"modelAlias"}},{"kind":"Field","name":{"kind":"Name","value":"minimumConfidenceBps"}},{"kind":"Field","name":{"kind":"Name","value":"canonicalDigest"}},{"kind":"Field","name":{"kind":"Name","value":"revision"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"userErrors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"field"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}}]}},{"kind":"Field","name":{"kind":"Name","value":"clientMutationId"}}]}}]}}]} as unknown as DocumentNode<Types.AdminUpdateAnalysisPromptMutation, Types.AdminUpdateAnalysisPromptMutationVariables>;