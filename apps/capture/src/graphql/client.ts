...
export const captureOperations = {
  ...
  accept: "mutation Accept($disclosureVersion:String!,$id:String!){acceptProcessing(input:{disclosureVersion:$disclosureVersion,photoProcessing:true,aiAnalysis:true,gpsUse:true,clientMutationId:$id}){status userErrors{message code}}}",
