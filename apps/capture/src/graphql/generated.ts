...
export type ExternalCaptureBootstrapQuery = { externalCapture: { responsibilityId: string, recaptureRequestId: string | null, status: string, confirmationOnly: boolean, kind: string, disclosureVersion: string, reference: Record<string, unknown>, policy: Record<string, unknown>, referenceItems: Array<{ mediaId: string, requirementKey: string, description: string, availability: string, imageUrl: string | null, imageUrlExpiresAt: string | null }>, requirements: Array<{ key: string, section: string, label: string, instructions: string | null, required: boolean, minimumMedia: number, maximumMedia: number, descriptionRequired: boolean, captureSourcePolicy: string, comparisonTarget: string, impossibilityAllowed: boolean }>, answers: Array<{ requirementKey: string, mediaIds: Array<string>, impossibilityReason: string | null, version: number }> } };
...
export type SaveCaptureMetadataMutation = { saveCaptureMetadata: { clientMutationId: string, media: { id: string, status: string, replacesMediaId: string | null } | null, userErrors: Array<{ code: string, field: string | null, message: string, correlationId: string }> } };
