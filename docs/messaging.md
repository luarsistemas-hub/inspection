...
Contratos incluem `inspection.created.v1`, `inspection.state_changed.v1`, `capture.submitted.v1`, `media.upload_completed.v1`, `media.verified.v1`, `analysis.comparison_requested.v1`, `inspection.classified.v1`, `report.ready.v1`, `notification.delivery_requested.v2`, `notification.delivery_terminal.v1`, `retention.purge_due.v1` e `retention.purged.v1`.
